                    ...
                    {products.map((product) => (
                        <div key={product.id} className='border bg-white border-gray-600 rounded overflow-hidden'>
                            ...
                            <div className='p-1'>
                                ...
                                <p className='text-slate-600'>Rp {product.hargaBarang - product.hargaBarang * 20 / 100}</p>
                                <p className='text-sm'><span className='text-red-500'>20%</span> <span className='line-through text-slate-400'>Rp {product.hargaBarang}</span></p>
                            </div>
                        </div>
                    ))}
                </Slider>
